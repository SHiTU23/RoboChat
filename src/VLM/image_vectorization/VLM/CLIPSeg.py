...
class CLIPSeg:
    ...
    def segment_object(self, image_path, texts, return_most_probable = False):
        '''
...
if __name__ == "__main__":
    ...
    texts = "yellow cube"
    object_features, segmented_image, boundingBoxed_image = clipseg.segment_object(image_path, texts, return_most_probable=True)
